...
- **D-Orbit 2024-01-11 row — RESOLVED 2026-05-05.** Verified via Marubeni's own 2023 press release + Spacewatch coverage: Marubeni signed the investment agreement Nov 9, 2023, but the actual first close of €100M/$110M Series C was January 11, 2024. The existing row date stands. The €50M second close (Sept 27, 2024) is correctly captured in the 3Q24 extension row.
